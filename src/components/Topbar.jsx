...
const Topbar = () => {
  return (  
        <header className='flex justify-between items-center px-4 py-3 border-b border-[#D9D9D9] sticky top-0 bg-[#FFFFFF]'>
            <div className='flex gap-2 sm:gap-4 items-center sm:flex-grow'>
                ...
                <div className='flex items-center gap-[6px] text-[#4D4D4D]'>
                  <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="text-sm" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='flex gap-2 justify-end sm:flex-grow'>
              <button className='text-[#4D4D4D] bg-[#E6E6E6] rounded-full p-2 sm:flex w-8 sm:w-10 items-center justify-center'>
                <img src='./images/speaker.png' alt='speaker logo' loading='lazy' />
              </button>
